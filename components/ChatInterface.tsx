...
const ChatInterface: React.FC<Props> = ({ userProfile, progressLogs }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-dark pb-20">
      {/* Header */}
      <div className="bg-secondary p-4 border-b border-gray-700 shadow-md sticky top-0 z-10">
      ...
      {/* Input */}
      <div className="p-4 bg-secondary border-t border-gray-700 sticky bottom-[70px]">
